...
export default function CourseDetail(){
    ...
    return <div>
        ...
        <div className={'col-span-2'}>
            {
                step ===1 && <Step1 video={stCourse.videos && stCourse.videos[0]}/>
            }
            {
                step ===2 && <div>1+1=2</div>
            }
            {
                step ===3 && <div className={'flex items-center justify-center'}><Image
                    width={400}
            ...
            <div className={'flex items-center justify-center mt-4'}>
                <Button color={'primary'} onClick={handleStep}>{step!==3 ? 'Next' : 'Mint'}</Button>
            </div>
        </div>
